        ...
        return (
          <div className="navigation">
            <a href="https://workers.cloudflare.com">
              <div className="logo">
                <svg
                  id="CloudflareWorkersLogoCombinationMarkHorizontal"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 1430 375"
                  role="img"
                  aria-labelledby="CloudflareWorkersLogoCombinationMarkHorizontal--title CloudflareWorkersLogoCombinationMarkHorizontal--desc"
                >
